...
recipes.addShaped("doggytalents:throw_stick_oredict", <doggytalents:throw_bone:2>, [
    [null, <ore:stickWood>, null],
    [<ore:stickWood>, <ore:slimeball>, <ore:stickWood>],
    [null, <ore:stickWood>, null]
]);

recipes.addShaped("doggytalents:throw_bone_oredict", <doggytalents:throw_bone:0>, [
    [null, <ore:bone>, null],
